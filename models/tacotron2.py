...
class Tacotron2(TacotronAbstract):
    def __init__(self,
                 ...
                 gst_style_tokens=10):
        super(Tacotron2,
              self).__init__(num_chars, num_speakers, speaker_embedding_dim, speaker_embedding_weights, r, postnet_output_dim,
    ...
    def forward(self, text, text_lengths, mel_specs=None, mel_lengths=None, speaker_embeddings=None):
    ...
    @torch.no_grad()
    def inference(self, text, speaker_embedding=None, style_mel=None):
        embedded_inputs = self.embedding(text).transpose(1, 2)
